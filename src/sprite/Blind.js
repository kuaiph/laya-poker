...
export default class Blind {
    ...
    move(chipSeatIdArr) {
        ...
        // 大盲顺时针移动
        this.textChipBig.x = this.seatMap[chipSeatIdArr[0]].imgSeat.x + 10
        this.textChipBig.y = this.seatMap[chipSeatIdArr[0]].imgSeat.y - 30
        // this.textChipBig.x = this.imgChipBig.x - 10
        // this.textChipBig.y = this.imgChipBig.y - 15
        // 小盲顺时针移动
        this.textChipSmall.x = this.seatMap[chipSeatIdArr[1]].imgSeat.x + 10
        this.textChipSmall.y = this.seatMap[chipSeatIdArr[1]].imgSeat.y - 30
